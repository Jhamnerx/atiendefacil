  ...
  const theme = createTheme(
    {
      ...
      palette: {
        type: mode,
        primary: { main: mode === "light" ? "#D21CD4" : "#FFFFFF" },
        textPrimary: mode === "light" ? "#D21CD4" : "#FFFFFF",
        borderPrimary: mode === "light" ? "#D21CD4" : "#FFFFFF",
        ...
        barraSuperior:
          mode === "light"
            ? "linear-gradient(to right, #D21CD4, #D21CD4 , #D21CD4)"
            : "#666",
